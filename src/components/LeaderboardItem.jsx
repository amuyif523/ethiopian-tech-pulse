    ...
    function LeaderboardItem({ item, index, onSelect }) {
      return (
        <button
          onClick={() => onSelect(item.login)}
          className="group w-full flex items-center gap-4 p-3 rounded-lg transition-all duration-200 hover:bg-white/5 text-left"
